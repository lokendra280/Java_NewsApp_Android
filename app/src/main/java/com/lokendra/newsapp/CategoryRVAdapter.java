...
public class CategoryRVAdapter extends RecyclerView.Adapter<CategoryRVAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CategoryRVAdapter.ViewHolder holder, int position) {
        ...
        Picasso.get().load(categoryRVModel.getCategoryImageUrl()).into(holder.categotyIV);
    ...
    public class ViewHolder  extends RecyclerView.ViewHolder{
        ...
        private ImageView categotyIV;
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            categoryTV = itemView.findViewById(R.id.idIVCategory);
            categotyIV = itemView.findViewById(R.id.idIVCategory);
        }
    }
}
